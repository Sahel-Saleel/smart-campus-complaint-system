...
There are no pre-created demo accounts. Log in with a management account created by `flask --app wsgi bootstrap-accounts`, then add student/staff accounts from the HOD's **Users** page.
...
✓ Can login with accounts created by the HOD / bootstrap command
